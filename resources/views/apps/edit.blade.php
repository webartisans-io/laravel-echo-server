                        ...
                        <form method="post" action="{{ route('websockets.admin.store') }}">
                            ...
                            <div class="form-check mt-2 mb-4">
                                <input class="form-check-input" type="checkbox" value="1" name="active" id="active"
                                       @if(optional($app)->active) checked @endif />
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control"
                                       value="{{ optional($app)->name ?? old('name') }}"/>
                            </div>

                            <div class="form-group">
                                <label>Host</label>
                                <input type="text" name="host" class="form-control"
                                       value="{{ optional($app)->host ?? old('host') }}"/>
                            </div>

                            <div class="form-check mt-2 mb-4">
                                <input class="form-check-input" type="checkbox" value="1" name="enable_client_messages"
                                       id="enable_client_messages"
                                       @if(optional($app)->enable_client_messages) checked @endif />
                            ...
                            <div class="form-check mt-2 mb-4">
                                <input class="form-check-input" type="checkbox" value="1" name="enable_statistics"
                                       id="enable_statistics" @if(optional($app)->enable_statistics) checked @endif />
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" readonly class="form-control-plaintext text-muted"
                                       value="{{ $app->key ?? "Unavailable" }}">
                            </div>

                            <div class="form-group">
                                <label>Secret</label>
                                <input type="text" readonly class="form-control-plaintext text-muted"
                                       value="{{ $app->secret ?? "Unavailable" }}">
                            </div>
